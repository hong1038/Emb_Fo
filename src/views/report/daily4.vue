                ...
                <div class="con_box_right container-fluid float-left">
                    ...
                    <div class="dailyTableSelectBox container-fluid">
                        <div>
                            ...
                            <div class="clickBtnWrap"><router-link class="tabbtn clickBtn" :to="{name: 'daily4'}">4. 설비적/기계적 문제 발생 및 대응 현황</router-link> </div>
                    ...
                    <div class="con_tableWrap container-fluid">
                        <div class="con_table" id="con_table04">
                            <ag-grid-vue style="width: 100%; height: 100%;" class="ag-theme-alpine-dark" :columnDefs="errorFields" :rowData="errorList" :gridOptions="gridOptions" :pagination="true" :paginationPageSize="paginationPageSize" v-b-visible="handleVisibility">
                            </ag-grid-vue>
                        </div>
                    </div>
                    </b-overlay>
