...
export default {
    ...
    data() {
        return {
            ...
            //1. 전체통계
            items:[
                {mainKey: '1', headerName : '환경모니터링', subCate : '설비적/기계적 문제 발생 및 대응 현황', subCate02 : '발생', unit:'건'},
                {mainKey: '2', headerName : '환경모니터링', subCate : '설비적/기계적 문제 발생 및 대응 현황', subCate02 : '조치', unit:'건'},
                {mainKey: '3', headerName : '환경모니터링', subCate : '설비적/기계적 문제 발생 및 대응 현황', subCate02 : '조치율', unit:'율'},
                {mainKey: '4', headerName : '악취', subCate : '모니터링 이상 대응', subCate02 : '발생', unit:'건'},
                {mainKey: '5', headerName : '악취', subCate : '모니터링 이상 대응', subCate02 : '조치', unit:'건'},
                {mainKey: '6', headerName : '악취', subCate : '모니터링 이상 대응', subCate02 : '조치율', unit:'율'},
                {mainKey: '7', headerName : '수질', subCate : '모니터링 이상 대응', subCate02 : '발생', unit:'건'},
                {mainKey: '8', headerName : '수질', subCate : '모니터링 이상 대응', subCate02 : '조치', unit:'건'},
                {mainKey: '9', headerName : '수질', subCate : '모니터링 이상 대응', subCate02 : '조치율', unit:'율'},
                {mainKey: '10', headerName : '대기', subCate : '모니터링 이상 대응', subCate02 : '발생', unit:'건'},
                {mainKey: '11', headerName : '대기', subCate : '모니터링 이상 대응', subCate02 : '조치', unit:'건'},
                {mainKey: '12', headerName : '대기', subCate : '모니터링 이상 대응', subCate02 : '조치율', unit:'율'},
            ],
            month:[
                {mainKey : '1', monthName : ''},
                {mainKey : '2', monthName : ''},
