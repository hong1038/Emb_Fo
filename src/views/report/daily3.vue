                ...
                <div class="con_box_right container-fluid float-left">
                    ...
                    <div class="dailyDateCheck container-fluid">
                        <b-row>
                            ...
                            <b-col cols="3" class="col-3">
                                <input type="button" class="d_btn01" value="조회" v-on:click="getList3">
                            </b-col>
                        </b-row>
                    </div>
                    ...
                    <div class="dailyTableSelectBox container-fluid">
                        <div>
                            ...
                            <div class="clickBtnWrap"><router-link class="tabbtn clickBtn" :to="{name: 'daily3'}">3. 배출구 초과이력 관리</router-link> </div>
                    ...
                    <div class="con_tableWrap container-fluid">
                        <div class="con_table" id="con_table03">
                            <ag-grid-vue style="width: 100%; height: 100%;" class="ag-theme-alpine-dark" :columnDefs="outletFields" :rowData="outletList" :gridOptions="gridOptions" :pagination="true" :paginationPageSize="paginationPageSize" v-b-visible="handleVisibility">
                            </ag-grid-vue>
                        </div>
                    </div>
                    </b-overlay>
